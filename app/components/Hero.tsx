...
export default function Hero() {
    return (
        <div className="flex flex-row gap-32 justify-center py-28">
            <div id="portrait">
                <img id="portrait-image" src="/portrait.jpg" alt="Edyta Sarnecka Portrait" className="w-72 h-96 object-cover rounded-4xl hover:scale-105 transition-all"/>
            </div>
